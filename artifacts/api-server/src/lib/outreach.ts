...
HOW TO ACTUALLY CLOSE (this is what separates a reply from a sale):
- Specificity sells. One concrete, true detail about THEM beats any generic flattery. Name the exact gap or number you were given.
- Sell the outcome, not the feature — more customers, more booked jobs, a full pipeline — then name the feature that delivers it.
- Kill the risk out loud. The single biggest reason they don't buy is fear it won't work. So explicitly hand them a no-risk way in — a free sample to check quality first, and/or the fact that any shortfall is automatically refunded — but ONLY use risk-reversals that appear in the sender's offer; never promise a guarantee you weren't given.
- Confidence, not hype. Sound like a proven operator who knows this works, not a desperate seller. No fake urgency, no "act now", no exclamation spam, no invented testimonials or stats.
- One ask. Every message drives to exactly one next step.
...
2. email.subject: 4-8 words. Promise a concrete outcome or spark genuine curiosity — specific beats clever. No spam-trigger words (free!, guarantee, $$$, act now), no ALL CAPS, no "Re:" tricks.
3. email.body: 70-120 words. Open with the concrete observation about THEM and the opportunity it implies (frame gaps as untapped customers). State plainly what the sender sells and the specific payoff of buying it. Land ONE credibility or risk-reversal beat drawn from the offer (free sample first, money-back / auto-refund on shortfall, or the entry-level price) so buying feels safe. Close with a single easy CTA — click the link to buy, or reply for a free sample. Then add a one-line "P.S." that restates the no-risk way in. Warm, human, peer-to-peer — not corporate. No fake personalization tokens, no "[Name]" — if you don't have a contact name, address the business naturally. Do NOT invent or append any company or personal name in the sign-off — leave the closing name out unless the sender's name is given to you below.
4. sms: under 300 characters, friendly, one sentence of value + one question. No links unless natural.
5. followUps: 2-3 timed nudges as {day, channel, subject?, body}. day = days after the first email (e.g. 3, 7). channel = "email" or "sms". Each adds a NEW angle or proof point and escalates the risk-free ask — never just "bumping this up". A good sequence: (1st) a specific result or use case, (2nd) the free-sample / money-back safety net again, (final) a short, graceful "should I close your spot?" walk-away that often pulls the reply. Repeat the link in follow-up emails. Emails need a subject; SMS omit it and stay under 300 chars.
...
- Otherwise write the response: answer their actual questions plainly using ONLY the sender's offer details below — never invent prices, dates, availability, or capabilities you weren't given. If they ask something you can't answer from the offer, say the sender will get back to them on that. Keep it 30-90 words, human and direct, matching their tone. Then CLOSE: when they show any interest, remove the last bit of friction and ask for the sale — point them at the offer's link to buy, quote the entry-level price to lower the barrier, and offer the no-risk step from the offer (a free sample, or money-back / auto-refund) so saying yes feels safe. If they're hesitant, propose the smallest possible commitment (a free sample or the cheapest pack) rather than pushing the full offer. Sound confident and helpful, never pushy. No greeting-card fluff, no restating your whole pitch.
